...
$$
Let's denote by 
$U_{i,k} = \theta_{k, r_{ik}} - \beta_k^\top x_i$ ,
$L_{i,k} = \theta_{k, r_{ik}-1} - \beta_k^\top x_i$,
$U_{i,l} = \theta_{k, r_{il}} - \beta_l^\top x_i$,
$L_{i,l} = \theta_{k, r_{ik}-1} - \beta_l^\top x_i$. We then have the rectangular probability:
$$
=\Phi_2\left(U_{i,k}, U_{i,l};  \rho_{kl} \right)-\Phi_2\left(L_{i,k}, U_{i,l};  \rho_{kl} \right)-\Phi_2\left(U_{i,k}, L_{i,l};  \rho_{kl} \right)
...
%-\frac{1}{p_i^{k,l}}\left(\frac{\partial\Phi_2(U_{i,k},U_{i,l},\rho)}{\partial U_{i,k}}\cdot \tilde %x^\text{upper}_{i,k} - \frac{\partial\Phi_2(U_{i,k},L_{i,l},\rho)}{\partial U_{i,k}}\cdot \tilde %x^\text{upper}_{i,k} - \frac{\partial\Phi_2(U_{i,l},L_{i,k},\rho)}{\partial L_{i,k}}\cdot \tilde %x^\text{lower}_{i,k} + \frac{\partial\Phi_2(L_{i,l},L_{i,k},\rho)}{\partial L_{i,k}}\cdot \tilde %x^\text{lower}_{i,k}\right)\\&
-\frac{1}{p_i^{k,l}}\left(\left(\frac{\partial\Phi_2(U_{i,k},U_{i,l},\rho)}{\partial U_{i,k}} - \frac{\partial\Phi_2(U_{i,k},L_{i,l},\rho)}{\partial U_{i,k}}\right)\cdot \tilde x^\text{upper}_{i,k} -  \left(\frac{\partial\Phi_2(U_{i,l},L_{i,k},\rho)}{\partial L_{i,k}} - \frac{\partial\Phi_2(L_{i,l},L_{i,k},\rho)}{\partial L_{i,k}}\right)\cdot \tilde x^\text{lower}_{i,k}\right)\\
\end{align*}


\begin{align*}
\frac{\partial\textrm{neglog}\mathcal L^{k,l}_{i}}{\boldsymbol \psi_l}&
%=-\frac{1}{p_i^{k,l}}\left(\frac{\partial\Phi_2(U_{i,k},U_{i,l},\rho)}{\partial U_{i,l}}\cdot \tilde %x^\text{upper}_{i,l} - \frac{\partial\Phi_2(U_{i,k},L_{i,l},\rho)}{\partial L_{i,l}}\cdot \tilde %x^\text{lower}_{i,l} - \frac{\partial\Phi_2(U_{i,l},L_{i,k},\rho)}{\partial U_{i,l}}\cdot \tilde %x^\text{upper}_{i,l} + \frac{\partial\Phi_2(L_{i,l},L_{i,k},\rho)}{\partial L_{i,l}}\cdot \tilde %x^\text{lower}_{i,l}\right)\\&
=-\frac{1}{p_i^{k,l}}\left(\left(\frac{\partial\Phi_2(U_{i,k},U_{i,l},\rho)}{\partial U_{i,l}} - \frac{\partial\Phi_2(U_{i,l},L_{i,k},\rho)}{\partial U_{i,l}}\right)\cdot \tilde x^\text{upper}_{i,l} -  \left(\frac{\partial\Phi_2(U_{i,k},L_{i,l},\rho)}{\partial L_{i,l}}\right) - \frac{\partial\Phi_2(L_{i,l},L_{i,k},\rho)}{\partial L_{i,l}}\cdot \tilde x^\text{lower}_{i,l}\right)\\
\end{align*}
...
$$
\textrm{neglog}\mathcal L^{k,l}_{i} = \log\left(2\pi\sigma_k\sigma_l\sqrt{1-\rho^2} \right) + \frac{1}{2\sqrt{1-\rho^2}}\underbrace{\left[\frac{(y_{i,k}-\bm\beta^*_k x^*_i)^2}{\sigma_k^2}-
2\rho\frac{(y_{i,k}-\bm\beta^*_k x^*_i)(y_{i,l}-\bm\beta^*_l x^*_i)}{\sigma_k\sigma_l} + 
\frac{(y_{i,l}-\bm\beta^*_l x^*_i)^2}{\sigma_l^2}
\right]}_{A}
$$
The relevant derivatives are:
\begin{align*}
\frac{\partial\textrm{neglog}\mathcal L^{k,l}_{i}}{\partial \bm\beta^*_{k}}& =  
\frac{1}{2\sqrt{1-\rho^2}}\left[\frac{2(y_{i,k}-\bm\beta^*_k \bm x^*_i)}{\sigma_k^2}(-\bm x^*_i)-
2\rho\frac{(y_{i,l}-\bm\beta^*_l \bm x^*_i)}{\sigma_k\sigma_l}(-\bm x^*_i) \right]\\
&=\frac{1}{\sqrt{1-\rho^2}}(-\bm x^*_i)\left[\frac{(y_{i,k}-\bm\beta^*_k \bm x^*_i)}{\sigma_k^2}-
\rho\frac{(y_{i,l}-\bm\beta^*_l\bm x^*_i)}{\sigma_k\sigma_l} \right]\\
\frac{\partial\textrm{neglog}\mathcal L^{k,l}_{i}}{\partial \bm\beta^*_{l}}& =  
\frac{1}{2\sqrt{1-\rho^2}}\left[\frac{2(y_{i,l}-\bm\beta^*_l\bm  x^*_i)}{\sigma_l^2}(-\bm x^*_i)-
2\rho\frac{(y_{i,k}-\bm\beta^*_k \bm x^*_i)}{\sigma_k\sigma_l}(-\bm x^*_i) \right]\\
&=\frac{1}{\sqrt{1-\rho^2}}(-\bm x^*_i)\left[\frac{(y_{i,l}-\bm\beta^*_l x^*_i)}{\sigma_l^2}-
\rho\frac{(y_{i,k}-\bm\beta^*_k)}{\sigma_k\sigma_l} \right]\\
%%
\frac{\partial\textrm{neglog}\mathcal L^{k,l}_{i}}{\partial \sigma_{k}}& =  \frac{1}{\sigma_k} + 
\frac{1}{2\sqrt{1-\rho^2}}\left[(y_{i,k}-\bm\beta^*_k x^*_i)^2(-2)\sigma_k^{-3}-
2\rho\frac{(y_{i,k}-\bm\beta^*_k \bm x^*_i)(y_{i,l}-\bm\beta^*_l \bm x^*_i)}{\sigma_l}(-\sigma^{-2}_k) \right]\\
&=\frac{1}{\sigma_k} + 
\frac{1}{\sqrt{1-\rho^2}}\left[-\frac{y_{i,k}-\bm\beta^*_k\bm  x^*_i)^2}{\sigma_k^{3}}+
...
\frac{1}{2\sqrt{1-\rho^2}}\left[(y_{i,l}-\bm\beta^*_l\bm  x^*_i)^2(-2)\sigma_l^{-3}-
2\rho\frac{(y_{i,k}-\bm\beta^*_k \bm x^*_i)(y_{i,l}-\bm\beta^*_l \bm x^*_i)}{\sigma_k}(-\sigma^{-2}_l) \right]\\
&=\frac{1}{\sigma_l} + 
\frac{1}{\sqrt{1-\rho^2}}\left[-\frac{y_{i,l}-\bm\beta^*_l x^*_i)^2}{\sigma_l^{3}}+
\rho\frac{(y_{i,k}-\bm\beta^*_k \bm x^*_i)(y_{i,l}-\bm\beta^*_l \bm x^*_i)}{\sigma_k\sigma^{2}_l} \right]\\
%%
\frac{\partial\textrm{neglog}\mathcal L^{k,l}_{i}}{\partial \rho}& =  -\frac{\rho}{\sqrt{1-\rho^2}} +\frac{\rho}{2(1-\rho^2)^{3/2}} A - \frac{1}{\sqrt{1-\rho^2}}
...
$$
\textrm{neglog}\mathcal L^{k,l}_{i} = \log\left(\Phi(\frac{\theta_{k, r_{ik}} - \mu_c}{\sigma_c}) - \Phi(\frac{\theta_{k, r_{ik}} - \mu_c}{\sigma_c})\right) + 0.5\log(2\pi)+\log(\sigma_l) + \frac{(y_{il} - \beta_{l}^{*\top} \bm x^*_i)^2}{2\sigma_l^2}
$$


Let $\eta^u_c=\frac{\theta_{k, r_{ik}} - \mu_c}{\sigma_c}$ and 
 $\eta^l_c=\frac{\theta_{k, r_{ik}-1} - \mu_c}{\sigma_c}$.
Let $\tilde p_{i}^{k,l} = \Phi(\frac{\theta_{k, r_{ik}} - \mu_c}{\sigma_c}) - \Phi(\frac{\theta_{k, r_{ik}} - \mu_c}{\sigma_c})$.
